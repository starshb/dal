...
import 'package:deliciousdal/bootpay/model/stat_item.dart';
...
class BootpayPlatform extends BootpayApi {
  ...
  BootpayPlatform() {
    ...
    _BootpayAsyncConfirm = allowInterop(
        onConfirmAsync); //js에서 BootpayAsyncConfirm 호출시 onConfirmAsync 수행
