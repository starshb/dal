import 'dart:async';
import 'dart:io';
import 'package:deliciousdal/bootpay/api/bootpay_analytics.dart';
import 'package:deliciousdal/bootpay/config/bootpay_config.dart';
import 'package:deliciousdal/bootpay/constant/bootpay_constant.dart';
...
import '../../../../bootpay_flutter-main/lib/bootpay.dart';
import '../../../../bootpay_flutter-main/lib/bootpay_api.dart';
import '../../../../bootpay_flutter-main/lib/bootpay_webview.dart';
import '../../../../bootpay_flutter-main/lib/controller/debounce_close_controller.dart';
import '../../../../bootpay_flutter-main/lib/model/payload.dart';
...
class BootpayPlatform extends BootpayApi {
  ...
  Future<void> goBootpayRequest(
    ...
    await Navigator.push(
      context,
      MaterialPageRoute(
          builder: (context) => WebViewRoute(webView, isTablet(context))),
    );
    webView = null;
  }
